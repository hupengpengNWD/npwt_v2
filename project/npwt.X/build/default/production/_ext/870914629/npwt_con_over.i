   ...
   if (con_flg_falla==0)
   {
...

    {
     ...
     if (flager_a&0x01)
     {
      ...
      if (load_perioda_up>10800 +1200
          || load_perioda_up>(10800)*2
       )
  ...
  else if (adc_ps00>=(target_press))
  {
            ...
            if (gao_cnt>run_time)
   {
    ...
    open_bum=0;
            ...
            if (gao_cnt>(run_time+499))
   {
# 310 "../../source/npwt_con_over.c"
     if (con_flg_falla==0)
    {
     cnt_cnta++;
     oppump_flg = 0;
  ...
  else
  {
   ...
   if(adc_ps00 >= 70)
   {
    ...
    if(mod_main_a == 3)
    {
     record_pre_compare_interval = 3000*2;
    }
    else
    {
     record_pre_compare_interval = 3000;
    }
   }
   else
   {
    ...
    if(mod_main_a == 3)
    {
     record_pre_compare_interval = 5000*2;
    }
    else
    {
     record_pre_compare_interval = 5000;
    }
   }
