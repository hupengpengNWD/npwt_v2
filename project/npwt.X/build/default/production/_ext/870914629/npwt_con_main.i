...
# 12 "../../source/npwt_con_main.c" 2
# 24 "../../source/npwt_con_main.c"
unsigned char ccnt1;
# 64 "../../source/npwt_con_main.c"
 ...
 else
 {
  ...
  else
  {
   ...
   if(ccnt1++>=10)
   {
    ...
    if(load_perioda_up++>10800)
    {
                    load_perioda_up=10800 +2200;
                }
    ...
    else if(load_perioda_up>LQ_FIR)
    {
     ...
     {flager_a = flager_a&(~0x01);}
# 136 "../../source/npwt_con_main.c"
   }
  }
 }
# 148 "../../source/npwt_con_main.c"
 if(cnt_cnta > 0)
 {
  cnt_cntaa++;
