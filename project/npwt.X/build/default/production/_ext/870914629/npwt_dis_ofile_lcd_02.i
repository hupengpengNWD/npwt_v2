# 1 "../../source/npwt_dis_ofile_lcd_02.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 285 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "../../source/npwt_dis_ofile_lcd_02.c" 2
...
# 2 "../../source/npwt_dis_ofile_lcd_02.c" 2
...
# 4 "../../source/npwt_dis_ofile_lcd_02.c" 2
...
# 5 "../../source/npwt_dis_ofile_lcd_02.c" 2
...
# 6 "../../source/npwt_dis_ofile_lcd_02.c" 2
...
# 7 "../../source/npwt_dis_ofile_lcd_02.c" 2
...
# 8 "../../source/npwt_dis_ofile_lcd_02.c" 2
...
# 9 "../../source/npwt_dis_ofile_lcd_02.c" 2
...
# 10 "../../source/npwt_dis_ofile_lcd_02.c" 2
...
# 11 "../../source/npwt_dis_ofile_lcd_02.c" 2
...
# 12 "../../source/npwt_dis_ofile_lcd_02.c" 2
...
void show_lq(void)
{
 ...
 if(show_lq_times.step==0)
 {
  ...
  if(read_key==0b00100000)
  {
   ...
   if(show_lq_times.buz_key_pressed_times++ >299)
...
void DISP_LixA(void)
{
 ...
 else
 {
  ...
  if(language)
  {
   DISP_ChaBasic(0,0,55+2);
   DISP_ChaBasic(0,0,61+2);
   DISP_ChaBasic(36,0,67+2);
   DISP_ChaBasic(48,0,73+2);
  }
  else
  {
...
# 497 "../../source/npwt_dis_ofile_lcd_02.c"
  if (add91200++>50)
  {
   add91200=0;
   add91201=adc_temp00;
  ...
  {
   dis_cnta=0;
   val_val = (run_tim_a/5)*5;

  }

  if ((val_val>mod_seta_preh+5)||(val_val>(mod_seta_preh-con_hi_delta)))
  {
...
# 562 "../../source/npwt_dis_ofile_lcd_02.c"
  if (language)
  {
...
# 712 "../../source/npwt_dis_ofile_lcd_02.c"
  if (add91200++>50)
  {
   add91200=0;
   add91201=adc_temp00;
...
# 814 "../../source/npwt_dis_ofile_lcd_02.c"
   }
...
# 891 "../../source/npwt_dis_ofile_lcd_02.c"
            }
            else
            {
...
# 933 "../../source/npwt_dis_ofile_lcd_02.c"
            if (language)
            {
...
# 1023 "../../source/npwt_dis_ofile_lcd_02.c"
  }
  else
  {
...
# 1065 "../../source/npwt_dis_ofile_lcd_02.c"
            if(language)
            {
                DISP_Dig14_16(2, 65+8,mod_seta_preh);
                disp_set_flg=1;
...
# 1088 "../../source/npwt_dis_ofile_lcd_02.c"
        if(language)
        {
            DISP_ChaBasic2('m',2,90+8);
   DISP_ChaBasic2('m',2,97+8);
...
# 1115 "../../source/npwt_dis_ofile_lcd_02.c"
  }
...
# 1146 "../../source/npwt_dis_ofile_lcd_02.c"
 }
...
# 1181 "../../source/npwt_dis_ofile_lcd_02.c"
  disp_set_flg=1;
...
# 1275 "../../source/npwt_dis_ofile_lcd_02.c"
 }
...
# 1336 "../../source/npwt_dis_ofile_lcd_02.c"
  val_val = set_moda;
  if (mod_seta_preh<100)
  {
   DISP_Dig15_32(4, 48);
...
void DISP_MainA(void)
{
 ...
 if (tim5_flg==0)
 {
  if (adc_temp00>=(mod_seta_preh-5))
  {
   adc_temp00 = mod_seta_preh;
  }
  else
  {
   adc_temp00 = (adc_temp00/5)*(5 +1);
  }
 }
 if (adc_temp00<5)
 {
 ...
 case 1:
 {
  ...
  if (mod_main_baka==2)
  {
   if(language){
    ...
    DISP_ChaBasic(0,0,52);
    DISP_ChaBasic(0,0,58);
    DISP_ChaBasic(36,0,64);
    DISP_ChaBasic(48,0,70);
   }else{
    DISP_lx(0,17);
    DISP_Fu1(0,31);
...
# 1566 "../../source/npwt_dis_ofile_lcd_02.c"
  if (lock_flg)
  {
   DISP_Lock(6,108);
  }
 ...
 case 5:
 {
  ...
  if (mod_main_baka==2)
  {
   ...
   if(language){
    DISP_ChaBasic(0,0,55);
    DISP_ChaBasic(0,0,61);
    DISP_ChaBasic(36,0,67);
    DISP_ChaBasic(48,0,73);
   }else{
    DISP_ChaBasic2015(0xAC,0,60);
    DISP_ChaBasic2015(0xAC,0,67);
    DISP_ChaBasic2015(0xC1,0,74);
...
# 1670 "../../source/npwt_dis_ofile_lcd_02.c"
  DISP_Info();
