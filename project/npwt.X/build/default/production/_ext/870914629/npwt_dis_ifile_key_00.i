# 1 "../../source/npwt_dis_ifile_key_00.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 285 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "../../source/npwt_dis_ifile_key_00.c" 2
...
# 2 "../../source/npwt_dis_ifile_key_00.c" 2
...
# 3 "../../source/npwt_dis_ifile_key_00.c" 2
...
# 4 "../../source/npwt_dis_ifile_key_00.c" 2
...
# 5 "../../source/npwt_dis_ifile_key_00.c" 2
...
# 6 "../../source/npwt_dis_ifile_key_00.c" 2
...
# 7 "../../source/npwt_dis_ifile_key_00.c" 2
...
# 8 "../../source/npwt_dis_ifile_key_00.c" 2
...
# 9 "../../source/npwt_dis_ifile_key_00.c" 2
...
# 10 "../../source/npwt_dis_ifile_key_00.c" 2
...
# 11 "../../source/npwt_dis_ifile_key_00.c" 2
...
# 13 "../../source/npwt_dis_ifile_key_00.c" 2
 ...
 if (key_port == key_port_bak)
 {
  if (key_cnt++>=5)
  {
   if (key_port == 0x3c)
   {
    ...
    else if (back_led_cnt++>1500)
    {
     {LATC = LATC&0xbf;};
    }
# 67 "../../source/npwt_dis_ifile_key_00.c"
    if (lock_cnt++>1500)
    {
     lock_flg=1;
    }
...
# 204 "../../source/npwt_dis_ifile_key_00.c"
 delta = press/10;
...
void MODE_ProA(void)
{
 ...
 case 0:
 {
  ...
  if ((PORTB&0x3c)==0x1c && key_mute_press_cnt++ > 100 && key_mute_press_cnt < 10000)
  {
   key_mute_press_cnt = 10000;
   if(key_silent_flag)
   {
    key_silent_flag = 0;
   }
   ...
   {
    key_silent_flag = 0x8000;
   }
  }
  if (mod_tim_cnta++>=(7000/20))
  {
   mod_main_a = 1;
   mod_tim_cnta = 0;
 ...
 case 4:
 {
  ...
  if (mod_seta_cnt == UI_WORKMODE_SELECT)
  {
   if (set_a00==0)
   {
    ...
    else if (key_val == 0x2c)
    {
     set_a00=1;
     mod_seta_wok = 3;
    }
    else if (key_val == 0x38)
    {
  ...
  else if (mod_seta_cnt==UI_MODE_SET_HI)
  {
   if (mod_seta_wok == 2)
   {
    if (key_val == 0x34)
    {
     mod_seta_preh=mod_seta_preh+10;
     if (mod_seta_preh>300)
     {
      mod_seta_preh=20;
     }
   ...
   if (mod_seta_preh < mod_seta_prel+10)
   {
  ...
  else if (mod_seta_cnt==UI_JIX_MODE_SET_LO)
  {
   ...
   if (key_val == 0x34)
   {
    mod_seta_prel = mod_seta_prel+10;
                if(mod_seta_prel > 100 || mod_seta_prel > mod_seta_preh - 10)
     mod_seta_prel = 10;
  ...
  else if (mod_seta_cnt==UI_JIX_SET_HI_TIME)
  {
   ...
   else if (key_val == 0xac)
   {
    ...
    key_set_tim=0;
    mod_seta_ont -= 5;
    if (mod_seta_ont > 99 || mod_seta_ont < 1)
    {
     mod_seta_ont=1;
    }
  ...
  else if (mod_seta_cnt==UI_JIX_SET_LO_TIME)
  {
   ...
   else if (key_val == 0xac)
   {
    ...
    key_set_tim=0;
    mod_seta_oft=mod_seta_oft-5;
    if (mod_seta_oft < 1 || mod_seta_oft > 99)
    {
     mod_seta_oft=1;
    }
 ...
 else if ( mod_main_a == 7 )
 {
  ...
  else
  {
   if (close_tim++>50)
   {
    ...
    LATAbits.LATA1=0;
    Flash_Erase(0xa000);
    Write_One_Word(0xa000, mod_seta_preh_bak);
    Write_One_Word(0xa000 +2, mod_seta_ont);
    Write_One_Word(0xa000 +4, mod_seta_oft);
    Write_One_Word(0xa000 +6, mod_main_baka);
    dataK = (unsigned int)(valueK*1000.0);
    dataK1 = dataK/1000;
    dataK2 = dataK%1000 /100;
    dataK3 = ( ( dataK%1000 )%100 ) /10;
    dataK4 = ( ( dataK%1000 )%100 )%10;
    Write_One_Word(0xa000 +8, dataK1);
    Write_One_Word(0xa000 +10,dataK2);
    Write_One_Word(0xa000 +12,dataK3);
    Write_One_Word(0xa000 +14,dataK4);
    key_silent_flag = (key_silent_flag | language);
    Write_One_Word(0xa000 +16,key_silent_flag);
    Write_One_Word(0xa000 +18,mod_seta_prel);
    LATCbits.LATC2=0;
   }
  }
 }
