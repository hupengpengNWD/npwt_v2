...
# 2 "<built-in>" 2
# 1 "../../source/npwt_con_ifile_adc.c" 2
...
# 2 "../../source/npwt_con_ifile_adc.c" 2
...
# 4 "../../source/npwt_con_ifile_adc.c" 2
...
# 5 "../../source/npwt_con_ifile_adc.c" 2
 unsigned char adc_ch,adc_cnt;
 unsigned short adc_buf[3*3];
 unsigned short adc_ps0,adc_bat = 315;
 unsigned short adc_zero;
# 18 "../../source/npwt_con_ifile_adc.c"
void ADC_Sort(void)
{
...
void ADC_Ps90(void)
{
# 92 "../../source/npwt_con_ifile_adc.c"
          ADC_DatCal();
