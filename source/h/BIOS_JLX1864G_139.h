...
#define DISP_Clr1()	{DISP_ClrZero(0,2,0,128);}

#define DISP_Clr2()	{DISP_ClrZero(2,4,0,128);}

#define DISP_Clr3()	{DISP_ClrZero(4,6,0,128);}

#define DISP_Clr4()	{DISP_ClrZero(6,8,0,128);}
